...
$configuration = mysql_query('SELECT * FROM config');
	
while($result=mysql_fetch_array($configuration)){ 
	$config_data[$result['config_key']]= $result['config_value'] ;
	$config_groups[$result['config_group']][$result['config_key']]=$result['config_value'];	
}
 ...
 //------------------------------------
 //$API_UserName = "singhshaktipidiyar-facilitator_api1.gmail.com";
 //$API_Password = "1363866826";
 //$API_Signature = "A9bT2mgpgYpoxyBuz7ltBZFgweBAAP3exwoCD43-94Nl2KuTioH1IRxp";
 ...
 $API_UserName = $site_configs['paypal_username'];
 $API_Password = $site_configs['paypal_password'];
 $API_Signature = $site_configs['paypal_sign'];
 $API_AppID = $site_configs['paypal_appid'];
 $API_Endpoint = "";
