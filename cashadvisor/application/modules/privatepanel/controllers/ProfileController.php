<?php
class  Privatepanel_ProfileController extends Zend_Controller_Action
{
	private $modelUser = "", $adminLogged ="" , $modelSecrate = "";
	public $module_name = "privatepanel/" , $controller_name = "profile";
			...
			if($form->isValid($data_post)){
				...
				if(is_object($is_update) and $is_update->success){
					if($is_update->row_affected > 0){
						...
						$mySession->infoMsg = " New Information is Same as Previous one ";
					}
